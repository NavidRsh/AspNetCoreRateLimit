...
This forked repo makes it possible to define a specific rule for an absolute url and it will be granted the higher priority compared to rules defined by relative patterns. 
